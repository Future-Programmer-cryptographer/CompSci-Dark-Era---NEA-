...
class RulesWindow: 
    def __init__(self, root): 
        ...
        titleLabel = ttk.Label(self.rulesFrame, text='Robo Rally Rules',  font=('fixedsys 20 bold'))
        ...
        text2 = ttk.Label(rulesFrame, text='-In this version of Robo Rally, there are only two main squares you need to worry about: obstacles and checkpoints. ', wraplength=300, justify='left')

        section3 = ttk.Label(rulesFrame, text='Health, scoring and winning criteria', font=('verdana', 10, 'bold'))
        text3 = ttk.Label(rulesFrame, text='-Every player starts of with 5 life \n -You lose a life if you hit an obstacle or go off grid', wraplength=300, justify='left')
